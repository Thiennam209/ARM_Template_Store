...
resource ingestfunction 'Microsoft.Web/sites/extensions@2015-08-01' = {
  ...
  properties: {
packageUri: 'https://github.com/Thiennam209/ARM_Template_Store/raw/main/functions/zipfiles/blade-functions.zip'
dbType: 'None'
    connectionString: ''
  }
  dependsOn: [
...
resource PostDeploymentscript 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  identity: {
    ...
    primaryScriptUri: 'https://raw.githubusercontent.com/Thiennam209/ARM_Template_Store/main/postdeploy.sh'
